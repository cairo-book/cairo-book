...
(function () {
   ...
   * @returns {string}
   */
  __exports.compileCairoProgram = function (cairo_program, replace_ids) {
    let deferred3_0;
    let deferred3_1;
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
   ...
   * @returns {string}
   */
  __exports.runCairoProgram = function (
    cairo_program,
    available_gas,
    allow_warnings,
    print_full_memory,
    ...
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.runCairoProgram(
        retptr,
        ptr0,
        len0,
        !isLikeNone(available_gas),
        isLikeNone(available_gas) ? 0 : available_gas,
        allow_warnings,
        print_full_memory,
        run_profiler,
        use_dbg_print_hint,
   ...
   * @returns {string}
   */
  __exports.compileStarknetContract = function (
    starknet_contract,
    allow_warnings,
    replace_ids,
  ) {
  ...
  function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_56a98561ec778df7 = function (arg0, arg1) {
