declare namespace wasm_bindgen {
   ...
   * @returns {string}
   */
  export function compileCairoProgram(
   ...
   * @returns {string}
   */
  export function runCairoProgram(
    cairo_program: string,
    available_gas: number | undefined,
    allow_warnings: boolean,
    print_full_memory: boolean,
    run_profiler: boolean,
    use_dbg_print_hint: boolean,
  ): string;
  /**
   * @param {string} cairo_program
   * @param {boolean} allow_warnings
  ...
  export function runTests(
    ...
    starknet: boolean,
    run_profiler: string,
    gas_disabled: boolean,
    print_resource_usage: boolean,
  ): string;
  /**
   ...
   * @returns {string}
   */
  export function compileStarknetContract(
...
declare interface InitOutput {
  ...
  readonly compileCairoProgram: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void;
  readonly runCairoProgram: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly compileStarknetContract: (
    a: number,
    b: number,
    c: number,
    d: number,
