...
async function main() {
  ...
  const compiledSierra = json.parse(
    fs
      .readFileSync("target/dev/syscall_receiver_contract.contract_class.json")
      .toString("ascii")
  );
  const compiledCasm = json.parse(
    fs
      .readFileSync(
        "target/dev/syscall_receiver_contract.compiled_contract_class.json"
      )
      .toString("ascii")
  );
  ...
  console.log("✅ Receiver Contract connected at =", myTestContract.address);
