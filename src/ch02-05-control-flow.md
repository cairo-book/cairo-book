...
```rust
{{#include ../listings/ch02-common-programming-concepts/no-listing-24-if.cairo}}
```
...
```rust
{{#include ../listings/ch02-common-programming-concepts/no-listing-25-else-if.cairo}}
```
...
```rust
{{#include ../listings/ch02-common-programming-concepts/no-listing-26-if-let.cairo}}
```
...
```rust
{{#include ../listings/ch02-common-programming-concepts/no-listing-27-loop.cairo}}
```
...
```rust
{{#include ../listings/ch02-common-programming-concepts/no-listing-28-loop-break.cairo}}
```
...
```rust
{{#include ../listings/ch02-common-programming-concepts/no-listing-29-loop-return-values.cairo}}
```
