...
to effectively use generic types with all of them.
...
Making a function generic means it can operate on different types, avoiding the
need for multiple, type-specific implementations. This leads to significant code
reduction and increases the flexibility of the code.
...
call _trait bounds_. The `main` function remains unchanged, the compiler is
...
implementation. This is referred to as an _anonymous generic implementation
parameter_.
