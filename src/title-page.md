...
This version of the text assumes you’re using the [Cairo Compiler](https://github.com/starkware-libs/cairo) [version 2.5.3](https://github.com/starkware-libs/cairo/releases). See the “Installation” section of Chapter 1 to install or update Cairo.
