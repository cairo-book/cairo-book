...
A smart contract cannot execute itself without an external trigger. It needs to
...
This chapter sheds light on how to interact with smart contracts and make them
interact with each other. Specifically, you'll learn what the _Application
Binary Interface (ABI)_ is, how to call a smart contract, and how to make
contracts communicate with each other. You will also learn how to properly use
classes as _libraries_, and when to use them.
