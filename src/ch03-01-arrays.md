...
directly modifying the memory cells.
...
detail in the ["References and Snapshots"][snapshots] chapter.
...
explained in more detail in the ["Enums and Pattern Matching"][enums] chapter.
