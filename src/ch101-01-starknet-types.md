...
When building smart contracts on Starknet, you'll work with specialized types
...
the Starknet-specific types provided by the Core library.
...
[Map](./ch101-01-01-storage-mappings.md) and
[Vec](./ch101-01-02-storage-vecs.md)), understanding this type is important for
...
the [Storage](./ch101-01-00-contract-storage.md) chapter.
...
Starknet provides several functions to access information about the current
execution context. These functions return specialized types or structures
containing blockchain state information.
