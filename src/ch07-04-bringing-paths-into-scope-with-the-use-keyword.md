...
Note that in this is case, `use core::array::ArrayTrait;` is optionnal to bring `ArrayTrait` trait into scope, because `ArrayTrait` is included in the prelude and therefore automatically brought into scope.
