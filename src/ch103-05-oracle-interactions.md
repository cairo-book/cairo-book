...
This section focuses on the concept of bringing off-chain data to the Starknet
...
to use
[Pragma price feeds](https://docs.pragma.build/Resources/Starknet/data-feeds/consuming-data)
and [Cartridge VRF](https://github.com/cartridge-gg/vrf) for verifiable random
numbers in games.

For further reading:

- Pragma Oracle price feeds:
  https://docs.pragma.build/Resources/Starknet/data-feeds/consuming-data
