...
Moreover, you can write your own implemention of the `PartialEq` trait for your type, if you don't want to or can't derive it. Here is an example in which we consider that two rectangles are equal if they have the same area:
