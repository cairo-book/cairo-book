...
If your compiler version is lower than `compiler-version 2.2.0`, and if you encounter `compiler-version` error while using the command above, you can specify your compiler version in the command: 
...
If you still encounter `compiler-version` error after specifying your compiler version, try upgrading Starkli using the command: `starkliup`
