...
- `read`, allowing to read the value of a storage variable. This method takes only one argument, which is the name of the variable being read. 
  
```rust,noplayground
{{#include ../listings/ch99-starknet-smart-contracts/listing_99_01/src/lib.cairo:read_state}}
```

- `write`, allowing to write a new value in a storage slot. This method takes 2 arguments, the name of the variable to be updated and the new value to be written.
