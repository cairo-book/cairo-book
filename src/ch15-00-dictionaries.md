...
```rust
{{#rustdoc_include ../listings/ch15-dictionaries/listing_15_02_entries.cairo:inserts}}
```
...
```rust
{{#rustdoc_include ../listings/ch15-dictionaries/listing_15_05_dict_struct_member.cairo:main}}
```
