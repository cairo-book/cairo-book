...
At its essence, hashing is a process of converting input data (often called a
...
a three-element state permutation with [specific
parameters][poseidon parameters].
...
using both the Pedersen and Poseidon hash functions.
